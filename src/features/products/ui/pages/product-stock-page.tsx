...
import { useStockMovements } from '../../application/use-stock-movements'
import { StockAdjustmentDialog } from '../stock/stock-adjustment-dialog'
...
export function ProductStockPage() {
  ...
  const { product, loading: loadingProduct, refresh: refreshProduct } = useProduct(productId)
